      ...
      <main className="pt-32 pb-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Dados que coletamos</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Finalidade do uso dos dados</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Integração com serviços Google</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Integração com Meta (Facebook e Instagram)</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Cookies e tecnologias de rastreamento</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Compartilhamento de dados</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Segurança das informações</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Retenção de dados</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Direitos do titular</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Uso responsável pelos clientes</h2>
              <p className="text-muted-foreground leading-relaxed">
